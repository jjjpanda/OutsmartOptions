...
dates1 = dataset1.slice(dataset1.findIndex(obj => obj.date == '2019-04-24') + 1,dataset1.findIndex(obj => obj.date=='2020-01-29'))
...
describe('Volatility Math Test', () => {
    ...
    it('Filter volatility spikes', () => {
        expect(math.filterSpikes(dataset1,math.findSpikes(dataset1, mean1, sd1))).toEqual(spikes1);
    });

    it('Find trough', () => {
        expect(math.findTrough(dates1,math.findSpikes(dataset1, mean1, sd1))).toEqual({date: '2019-05-08', iv: 0.6541888056369215})
    });
