  ...
  constructor(props) {
    ...
    guide1() {
      Modal.info({
        ...
        content: (
          <iframe width="500" height="300" src="https://www.youtube.com/embed/JrGp4ofULzQ" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
        ),
        width: 600,
      });
    }
